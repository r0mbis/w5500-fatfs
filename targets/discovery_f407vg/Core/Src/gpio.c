...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = W550_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(W550_INT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_PORT, LED_GREEN, GPIO_PIN_RESET);

  /*Configure GPIO pin : LED_Green Pin */
  ...
  /*Configure GPIO pin : LED_Orange Pin */
  GPIO_InitStruct.Pin = LED_ORANGE;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_PORT, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : LED_Red Pin */
  ...
  /*Configure GPIO pin : LED_Blue Pin */
